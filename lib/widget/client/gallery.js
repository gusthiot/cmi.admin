...
Template.Widget$Gallery$gallery.helpers({
  galleryItemOf () {
    return {template: "Widget$Gallery$test2"};  // TODO: remove
  },
  ...
  myCallbacks: {
    ...
    widgetCreated: function(widget) {
      debugger;
      widget.parentTemplateInstance().demoWidget = widget;
    }
  }
});

// Example of a constructed template. TODO: refactor
...
Meteor.startup(() => {
  Widget.mapClasses(function (widgetClass, widgetClassName) {
    ...
    return; // TODO: propagate user changes as we used to below,
