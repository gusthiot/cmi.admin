...
GalleryItem.prototype.asTemplateData = function(templateInstance, templateData) {
  return {
    ...
    callbacks: {
      ...
      widgetValueChanged: function(newValue) {
        templateInstance.$("input.external-value").val(newValue);
      }
    }
  };
};
  ...
  myCallbacks: function() {
    ...
    return {
      ...
      widgetCreated: function() {
        ...
        templateInstance.widget = this;
      },
      widgetValueChanged: function(newValue) {
        templateInstance.$('div').css('background-color', newValue.toLowerCase());
      },
    }
  }
});
