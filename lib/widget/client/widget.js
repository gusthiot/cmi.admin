...
Widget.declareClass("Select")
    ...
    value: '',   // TODO: move into superclass, but careful: .viewmodel() may not be called several times
    events: {
...
Template.Widget$Date$editable.onRendered(function () {
    this.$('#datepicker').assertSizeEquals(1).datepicker({
        showWeek: true,
        weekHeader: "W"
    });
    // http://senthilraj.github.io/TimePicki/options.html#
    this.$('#timepicker').assertSizeEquals(1).timepicki({
