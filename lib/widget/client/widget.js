...
Widget.declareClass("Date")
    .helpers({
        asDatePickerTime: function (time) {
            return moment.utc(time, dateFormatExpectedByDatetimepicker()).format(dateFormatExpectedByDatetimepicker());
        },
        formattedDate: function () {
            return (moment(Template.currentData().startTime, dateFormatExpectedByDatetimepicker()).format(dateFormatExpectedByDatetimepicker()));
        },
