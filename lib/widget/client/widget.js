...
WidgetBase.prototype.dataContextForInnerTemplate = function(dataContext) {
    var id = dataContext._id,
        vmTag = dataContext.vmTag,
        contextCopy = _.extend({}, dataContext);
    delete contextCopy._id;
    delete contextCopy.vmTag;

     var widgetContext = _.extend(contextCopy,
