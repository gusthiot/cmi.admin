...
function momentToLocalizedString(momentFormat, t) {
    if (t === undefined) {
        return undefined;
    }
...
Widget.declareClass("Date")
    .helpers({
        dateToLocalizedString: momentToLocalizedString.bind({}, "l"),
        toDatePickerInputValue: momentToLocalizedString.bind({}, "l"),
    }).viewmodel({
      value: ''
    });
