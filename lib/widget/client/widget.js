...
Widget.declareClass("TextAreaDetails");
...
Widget.declareClass("Date")
    .helpers({
        asDatePickerTime: function (time) {
            return moment(time).format(dateFormatExpectedByDatetimepicker());
        },
        formattedDate: function () {
            return (moment( Template.currentData().startTime ).format(dateFormatExpectedByDatetimepicker()));
        }
    }).viewmodel({
        value: '',
    });
