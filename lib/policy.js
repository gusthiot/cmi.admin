var debug = require("debug")("lib/policy.js");
...
PolicyBase.prototype.call = function(/* opt_publish_that, *args */) {
  ...
  if (! user) {
    // We could easily accommodate policies that also grant access to logged-out
 ...
 * a proposed MongoDB mutation against a SimpleSchema.
 *
 ...
 * side, policy enforcement is done through aldeed:collection2.
 *
 * @constructor
 */
